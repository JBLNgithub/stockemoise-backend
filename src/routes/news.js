...
router.post('/with-event&location', mustBeLoggedIn, mustBeOperator, validateNews, validateEventNews, validateNewLocation, validateLocality, localityMustExists, addNewsAndEventAndLocation)
router.post('/with-event&location&locality', mustBeLoggedIn, mustBeOperator, validateNews, validateEventNews, validateNewLocation, validateNewLocality, localityMustNotExists, addNewsAndEventAndLocationAndLocality)
